...
function isFieldHaveTypeFunction(stateClass, fieldName) {
    var _a, _b;
    return (!((_a = Object.getOwnPropertyDescriptor(stateClass, fieldName)) === null || _a === void 0 ? void 0 : _a.get) &&
        !((_b = Object.getOwnPropertyDescriptor(stateClass, fieldName)) === null || _b === void 0 ? void 0 : _b.set) &&
    ...
    emitMetadataOperation(type) {
        ...
        if (this._devtoolsConfig.isEnabled) {
            ...
            operationEmitter$.next({
                ...
                classContext: (_a = this.initialConfig) === null || _a === void 0 ? void 0 : _a.context,
...
class ArrayState extends BaseState {
    ...
    */
    updateItem(itemToUpdate) {
        const items = this.data;
        const newItemToUpdate = Object.assign({}, itemToUpdate);
...
class ObjectState extends BaseState {
    ...
    updateWithPartial(value) {
        this.set(Object.assign(Object.assign({}, this.data), value));
    }
    setNewValue(value) {
        if (value) {
            super.setNewValue(Object.assign({}, value));
        }
        else {
            super.setNewValue(null);
        }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.4", ngImport: i0, type: NgxBaseStateDevtoolsModule, decorators: [{
        ...
        return [{ type: NgxBaseStateDevtoolsConfig, decorators: [{
                        type: Inject,
